...
public class DescendingFollowingHint extends FollowingHint{

    public DescendingFollowingHint(List<List<Integer>> followingPositions){
    ...
    public String showHintInFrench() {
        ...
        return "- Les chiffres en " + positionString + " positions se suivent dans l'ordre décroissant.";
    }
    ...
    public String showHintInEnglish() {
        ...
        return "- The digits at " + positionString + " positions are following each other in descending order.";
    }
